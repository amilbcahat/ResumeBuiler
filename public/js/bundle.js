...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"createResume.js":[function(require,module,exports) {
"use strict";
...
var createResume = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === "success") {
              (0, _alerts.showAlert)("success", "Your Resume has been created successfully");
              window.setTimeout(function () {
                console.log(res);
                window.location.replace("/user/resume1/".concat(res.data.data.data.id));
              }, 1500);
            }
          ...
          case 8:
            ...
            (0, _alerts.showAlert)("error", _context.t0.response.data.message); // console.log(err.response.data.message);
  ...
  return function createResume(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.createResume = createResume;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"updateResume.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updateSettings = exports.editResume = exports.deleteResume = void 0;
...
var deleteResume = /*#__PURE__*/function () {
        ...
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.data.data === null) {
              (0, _alerts.showAlert)("success", "Your Resume has been deleted successfully");
              window.setTimeout(function () {
                location.assign("/dashboard");
              }, 1500);
            }
  ...
  return function deleteResume(_x3) {
    return _ref2.apply(this, arguments);
  };
}();
...
var editResume = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(id, name, email, objective, achievements, edudetails, edudetails1, edutimeperiod1, edutimeperiod, skill, hobbies, phone, about, location, project1, project2, photo, designation, linkedin) {
    var res;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            return (0, _axios.default)({
              ...
              data: {
                ...
                edudetails1: edudetails1,
                edutimeperiod1: edutimeperiod1,
                edutimeperiod: edutimeperiod,
                skill: skill,
                hobbies: hobbies,
                phone: phone,
                about: about,
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              (0, _alerts.showAlert)("success", "Your Resume has been updated successfully");
              window.setTimeout(function () {
                window.location.href = "/user/resume1/".concat(id);
              }, 1500);
            }
  ...
  return function editResume(_x4, _x5, _x6, _x7, _x8, _x9, _x10, _x11, _x12, _x13, _x14, _x15, _x16, _x17, _x18, _x19, _x20, _x21, _x22) {
...
var _createResume = require("./createResume");

var _updateResume = require("./updateResume");
...
var resumeForm = document.querySelector(".form--resume");
...
if (loginForm) {
  document.querySelector(".form--login").addEventListener("submit", function (e) {
    ...
    var password = document.getElementById("password").value; // console.log('button clicked');
...
if (signupForm) {
  document.querySelector(".btn-signup").addEventListener("click", function (e) {
    ...
    var passwordConfirm = document.getElementById("passwordConfirm").value; // console.log('button clicked');
...
if (resumeForm) {
  document.querySelector(".form--resume").addEventListener("submit", function (e) {
    e.preventDefault();
    var name = document.getElementById("name").value;
    var email = document.getElementById("email").value;
    ...
    var edudetails = document.getElementById("edudetails").value;
    ...
    var edutimeperiod1 = document.getElementById("edutimeperiod1").value;
    var edutimeperiod = document.getElementById("edutimeperiod").value;
    var linkedin = document.getElementById("linkedin").value;
    var skill = document.getElementById("skill").value;
    var hobbies = document.getElementById("hobbies").value;
    var designation = document.getElementById("designation").value;
    var location = document.getElementById("location").value;
    var photo = document.getElementById("photo").files[0]; // console.log(photo);
    ...
    form.append("photo", photo); // console.log(form.get(name));

    (0, _createResume.createResume)(form, "data");
  });
}
...
if (btnDelete) {
  document.querySelector(".btn--delete").addEventListener("click", function (e) {
    e.preventDefault();
    var id = document.querySelector(".right").dataset.id;
    (0, _updateResume.deleteResume)(id);
  });
}

if (btnEdit) {
  document.querySelector(".btn--edit").addEventListener("click", /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
      var id, name, email, objective, phone, about, edudetails, achievements, project1, project2, edudetails1, edutimeperiod1, edutimeperiod, linkedin, skill, hobbies, designation, location, photo;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault();
              id = document.querySelector(".right").dataset.id; // console.log(id);
              ...
              edudetails = document.getElementById("edudetails").value;
              achievements = document.getElementById("achievements").value;
              project1 = document.getElementById("project1").value;
              project2 = document.getElementById("project2").value;
              edudetails1 = document.getElementById("edudetails1").value;
              edutimeperiod1 = document.getElementById("edutimeperiod1").value;
              edutimeperiod = document.getElementById("edutimeperiod").value;
              ...
              console.log(hobbies); // const form = new FormData();
              // form.append("name", name);
              // form.append("email", email);
              // form.append("objective", objective);
              // form.append("phone", phone);
              ...
              console.log(hobbies); // console.log(form.get(hobbies));

              (0, _updateResume.editResume)(id, name, email, objective, achievements, edudetails, edudetails1, edutimeperiod1, edutimeperiod, skill, hobbies, phone, about, location, project1, project2, photo, designation, linkedin);
