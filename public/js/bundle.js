...
var createResume = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(name, email, objective, achievements, phone, about, edudetails, skill, project, hobbies, regards) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              ...
              window.setTimeout(function () {
                location.assign("/user/resume1/".concat(res.data.data.data.id));
              }, 1500);
            }
  ...
  return function createResume(_x, _x2, _x3, _x4, _x5, _x6, _x7, _x8, _x9, _x10, _x11) {
    return _ref.apply(this, arguments);
  };
}();
...
var editResume = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(name, email, objective, achievements, phone, about, edudetails, skill, project, hobbies, regards, id) {
    var res;
        ...
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              ...
              window.setTimeout(function () {
                location.assign("/user/resume1/".concat(id));
              }, 1500);
            }
  ...
  return function editResume(_x4, _x5, _x6, _x7, _x8, _x9, _x10, _x11, _x12, _x13, _x14, _x15) {
...
if (resumeForm) {
  document.querySelector(".form--resume").addEventListener("submit", function (e) {
    ...
    var regards = document.getElementById("regards").value;
    var skill = document.getElementById("skill").value;
    var project = document.getElementById("project").value;
    var hobbies = document.getElementById("regards").value; // console.log('button clicked');

    (0, _createResume.createResume)(name, email, objective, achievements, phone, about, edudetails, skill, project, hobbies, regards);
  });
}
...
if (btnEdit) {
  document.querySelector(".btn--edit").addEventListener("click", function (e) {
    e.preventDefault();
    var id = document.querySelector(".right").dataset.id; // location.assign(`/editResume/${id}`);
